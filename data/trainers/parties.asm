...
MortyGroup:
	...
	db 21, GASTLY,     LICK, MEAN_LOOK, CURSE, NO_MOVE
...
ClairGroup:
	...
	db 37, DRAGONAIR,  THUNDER_WAVE, SURF, SLAM, NO_MOVE
	db 37, DRAGONAIR,  THUNDER_WAVE, THUNDERBOLT, SLAM, NO_MOVE
	db 37, DRAGONAIR,  THUNDER_WAVE, ICE_BEAM, SLAM, NO_MOVE
	db 40, KINGDRA,    SMOKESCREEN, SURF, HYPER_BEAM, NO_MOVE
	db -1 ; end
...
Rival1Group:
	...
	db 20, HAUNTER,    LICK, MEAN_LOOK, CURSE, NO_MOVE
	...
	; RIVAL1 (9)
	db "?@", TRAINERTYPE_MOVES
	db 20, HAUNTER,    LICK, MEAN_LOOK, CURSE_ NO_MOVE
	db 18, MAGNEMITE,  TACKLE, THUNDERSHOCK, SUPERSONIC, SONICBOOM
	db 20, ZUBAT,      LEECH_LIFE, SUPERSONIC, BITE, CONFUSE_RAY
...
SailorGroup:
	...
	db 38, POLIWRATH,  SURF, STRENGTH, ICE_PUNCH, NO_MOVE
	db -1 ; end
